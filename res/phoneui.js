	...
	if(window.navigator.standalone != true && 
		...
		if(GetCookie(cname)) {
			...
			myImage.onload = function() {
				// ctx.translate(0, myImage.height);
				ctx.save();
				if (onipad) {
				...
				var t = ['Click on + to add', 'this page to your', 'homescreen'];
